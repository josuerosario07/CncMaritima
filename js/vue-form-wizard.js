! function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.VueFormWizard = e() : t.VueFormWizard = e()
    ...
    return function (t) {
        ...
        e.a = {
            ...
            methods: {
                ...
                activateTabAndCheckStep: function (t) {
        ...
        e.a = {
            ...
            computed: {
                iconActiveStyle: function () {
                    return {
                        backgroundColor: this.tab.color
                    }
                },
                stepCheckedStyle: function () {
                    return {
        ...
        var n = function () {
            ...
            return a("li", {
                ...
                class: {
                    checked: t.tab.checked, square_shape: t.isStepSquare, tab_shape: t.isTabShape
                },
                ...
                class: {
                    square_shape: t.isStepSquare, tab_shape: t.isTabShape
                },
                ...
                class: {
                    active: t.tab.active, has_error: t.tab.validationError
                },
